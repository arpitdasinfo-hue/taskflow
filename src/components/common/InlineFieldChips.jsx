...
export const InlinePriorityChip = memo(function InlinePriorityChip({
  value,
  onChange,
  labels,
  colors,
  ...
  return (
    ...
    >
      <button
        ...
        style={{ background: `${colors[value]}16`, color: colors[value] }}
        title="Priority"
      >
        <span className="w-1.5 h-1.5 rounded-full" style={{ background: colors[value] }} />
        {labels[value]}
        <ChevronDown size={compact ? 10 : 11} />
      </button>
              ...
              return (
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full" style={{ background: colors[optionValue] }} />
                    {optionLabel}
                  </span>
                  {active && <Check size={13} />}
                </button>
