  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 px-6">
      ...
      <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
        {filtered ? 'No scheduled items match this view' : 'No timeline data yet'}
      </p>
      <p className="text-xs text-center max-w-sm" style={{ color: 'var(--text-secondary)' }}>
        {filtered
          ? 'Try clearing filters or quick conditions to broaden the timeline.'
          : 'Set start dates or due dates on projects/tasks and they will appear in this timeline.'}
      </p>
    </div>
  )
})
